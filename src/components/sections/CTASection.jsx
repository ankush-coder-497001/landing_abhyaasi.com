    ...
    <section className="py-24 px-4 bg-card relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center scroll-animate relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
          <button className="group inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-accent text-accent-foreground rounded-lg text-xs font-semibold hover:opacity-90 transition-all hover:gap-3">
            Start Free Today
            <ArrowRight className="w-3.5 h-3.5" />
          </button>
          <button className="px-6 py-2.5 border border-border bg-background text-foreground rounded-lg text-xs font-semibold hover:bg-card hover:border-accent/30 transition-colors">
            Schedule Demo
          </button>
        </div>
